class IngredientNameNormalizerDe {
  ...
  static String normalize(String raw) {
    ...
    // Explicit common ingredient spelling variants.
    s = s
        .replaceAll('olivenoel', 'olivenöl')
        .replaceAll('fruehlingszwiebeln', 'frühlingszwiebeln')
        .replaceAll('fruehlingszwiebel', 'frühlingszwiebel');
